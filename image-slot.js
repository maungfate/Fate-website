...
(() => {
  ...
  // Cap for the resized copy stored in the sidecar. 2400px keeps full-screen
  // lightbox viewing crisp on retina without making the JSON file enormous.
  const MAX_DIM = 2400;
  ...
  class ImageSlot extends HTMLElement {
    ...
    async _ingest(file) {
      ...
      const gen = ++this._gen;
      try {
        // Always encode close to MAX_DIM so even small inline slots (e.g.
        // exhibition thumbs) hold up at full-screen lightbox zoom. Smaller
        // images keep their original size; bigger ones cap at MAX_DIM.
